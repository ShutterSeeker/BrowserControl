...
# GitHub Personal Access Token for automatic error reporting
# Get token from: https://github.com/settings/tokens
# Create a token with 'repo' scope for creating issues
GITHUB_TOKEN = "your_github_token_here"  # Replace with your actual token
GITHUB_ISSUES_REPO = "ShutterSeeker/BrowserControl"
